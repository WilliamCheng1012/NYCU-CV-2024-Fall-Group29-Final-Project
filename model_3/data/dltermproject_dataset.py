...
class DltermprojectDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        if opt.phase == 'train':
            ...
            self.natural_dir_A1 = os.path.join(opt.dataroot, 'real_data', 'transmission_layer')
        ...
        self.dir_A1 = os.path.join(opt.dataroot, 'real_data', 'transmission_layer')
        # self.dir_A2 = os.path.join(opt.dataroot, 'real_data\\transmission_layer')
        self.dir_A2 = os.path.join(opt.dataroot, 'real_data', 'transmission_layer')
