...
parser.add_argument("--gpu_id", default="0", help="Specify GPU ID to use")
...
print("Task path:", task)
if not os.path.exists(task):
    print("Checkpoint directory does not exist:", task)
else:
    print("Files in checkpoint directory:", os.listdir(task))
...
if is_training:
    ...
    def prepare_data(train_path):
        ...
        for dirname in train_path:
            ...
            print("train_t_gt: ", train_t_gt)
            train_r_gt = dirname + "reflection_layer/"
            print("train_r_gt: ", train_r_gt)
            train_b = dirname + "blended/"
            print("train_b: ", train_b)
            print("sorted(os.walk(train_t_gt)): ", sorted(os.walk(train_t_gt)))
    ...
    print("train_syn_root: ", train_syn_root)
    print("train_real_root: ", train_real_root)
    _, syn_image1_list, syn_image2_list = prepare_data(train_syn_root)
    # print("syn_image1_list: ", syn_image1_list)
    # print("syn_image2_list: ", syn_image2_list)
    ...
    # print("input_real_names: ", input_real_names)
    # print("output_real_names1: ", output_real_names1)
    # print("output_real_names2: ", output_real_names2)
...
# To test the model on images with reflection
    ...
    test_path = ["../data/testing_set/testdata_reflection_synthetic_table2/blended/"]
    subtask = "synthetic_table2"  # if you want to save different testset separately
    # test_path = ["../data/testing_set/SIR2/SolidObjectDataset/blended/"]
    # subtask = "SolidObjectDataset"
    # test_path = ["../data/testing_set/SIR2/PostcardDataset/blended/"]
    # subtask = "Postcard"
    # test_path = ["../data/testing_set/Nature/blended/"]
    # subtask = "Nature"
    # test_path = ["../data/testing_set/SIR2/Wildscene/blended/"]
    # subtask = "Wildscene"
